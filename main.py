...
from platform_api import build_platform_router
...
app.include_router(build_platform_router(engine))
...
def regional_supplies(body: RegionalSuppliesBody):
    ...
    return build_regional_supplies(body.lat, body.lon, body.location_label, items)
